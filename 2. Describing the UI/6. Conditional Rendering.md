...
The problem is that the information about each drink
is spread across multiple conditions.
...
Once you’ve refactored the code to use if,
do you have further ideas on how to simplify it?
